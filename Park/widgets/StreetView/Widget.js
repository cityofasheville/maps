...
define([
  ...
  function (declare, _WidgetsInTemplateMixin, BaseWidget, Graphic, Point, PanelManager,
...
//          console.info("End BNG X: " + mPoint.x + ", " + "Y: " + mPoint.y);
      ...
      detectChromeBlocker: function () {
        ...
        setTimeout(lang.hitch(this, function () {
          console.info(pop.document.documentElement.clientWidth);
      ...
      _getBackgroundColorFromTheme: function(){
        ...
        /*TabTheme*/
          ...
          case "TabThemeyellow":
            ...
            break;
        /*PlateauTheme*/
          case "PlateauThemeblack":
            returnColor = "000000";
            break;
          case "PlateauThememedium-grey":
            returnColor = "6e6e6e";
            break;
          case "PlateauThemedefault":
            returnColor = "464646";
            break;
          case "PlateauThemedark-blue":
            returnColor = "004575";
            break;
          case "PlateauThemeesri-blue":
            returnColor = "007ac2";
            break;
          case "PlateauThemedark-green":
            returnColor = "2a7433";
            break;
          case "PlateauThemeesri-green":
            returnColor = "35ac46";
            break;
          case "PlateauThemeorange":
            returnColor = "da4d1e";
            break;
        /*Unknown*/
          default:
