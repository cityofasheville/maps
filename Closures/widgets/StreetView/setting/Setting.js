    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      setConfig: function(config) {
        ...
        setTimeout(function(){
          ...
          helpLink[0].href = 'http://gis.calhouncounty.org/WAB/V2.0/widgets/StreetView/help/streetview_Help.htm';
          html.setStyle(helpLink[0],'display','block');
        },600);
        this.config = config;
        this.hideCbx.setValue(this.config.hidestreetviewvwidowwhenminimized);
        this.svPopupHeight.set('value', parseInt(this.config.windowproperties.height, 10));
        this.svPopupWidth.set('value', parseInt(this.config.windowproperties.width, 10));
